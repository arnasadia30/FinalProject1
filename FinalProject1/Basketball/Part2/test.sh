...
do
	...
	hadoop jar /usr/local/hadoop/share/hadoop/tools/lib/hadoop-streaming-3.3.1.jar \
		-file ../../FinalProject1/Basketball/Part2/bb_mapper.py -mapper ../../FinalProject1/Basketball/Part2/"bb_mapper.py \"${centroids[0]}\" \"${centroids[1]}\" \"${centroids[2]}\" \"${centroids[3]}\"" \
    -file ../../FinalProject1/Basketball/Part2/bb_reducer.py -reducer ../../FinalProject1/Basketball/Part2/bb_reducer.py \
...
hadoop jar /usr/local/hadoop/share/hadoop/tools/lib/hadoop-streaming-3.3.1.jar \
	-file ../../FinalProject1/Basketball/Part2/bb_mapper2.py -mapper ../../FinalProject1/Basketball/Part2/"bb_mapper2.py \"${centroids[0]}\" \"${centroids[1]}\" \"${centroids[2]}\" \"${centroids[3]}\"" \
	-file ../../FinalProject1/Basketball/Part2/bb_reducer2.py -reducer ../../FinalProject1/Basketball/Part2/bb_reducer2.py \
	-input /task2/shot_logs.csv \
